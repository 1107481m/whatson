...
def populate():
    ...
    add_private_event("test event 1", 1, "2015-03-2 19:00", "2015-03-22 19:00")
    add_private_event("test event 2", 2, "2015-03-22 03:00", "2015-03-27 01:00")
    add_private_event("test event 3", 2, "2015-03-30 15:00", "2015-04-01 19:00")
    add_private_event("test event 4", 2, "2015-03-05 12:00", "2015-03-06 09:21")
    add_private_event("test event 5", 3, "2015-03-06 13:30", "2015-03-07 03:00")
    add_private_event("test event 6", 3, "2015-03-01 19:40", "2015-03-01 19:00")
...
def add_private_event(name, calendar, time, endTime):
    pe = PrivateEvent.objects.get_or_create(name=name, calendar_id=calendar, time=time, endTime=endTime)
    return pe
