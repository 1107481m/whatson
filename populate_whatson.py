...
def populate():
    ...
    add_private_calendar(3, "Jack's calendar", "#000000")
    ...
    add_private_event("Web App Development (Lecture)", 1, "2015-03-04 11:00", "2015-03-04 12:00", 2)
    ...
    add_private_event("Web App Development (Lecture)", 1, "2015-03-06 11:00", "2015-03-06 12:00", 2)
    add_private_event("ADS2 (Examples)", 1, "2015-03-06 13:00", "2015-03-06 14:00", 2)
    add_private_event("JOOSE 2 (Tutorial)", 1, "2015-03-06 14:00", "2015-03-06 15:00", 2)
    ...
    add_private_event("Web App Development (Lecture)", 1, "2015-03-11 11:00", "2015-03-11 12:00", 2)
    add_private_event("JOOSE 2 (Lecture)", 1, "2015-03-11 13:00", "2015-03-11 14:00", 2)
    add_private_event("Web App Development (Lab)", 1, "2015-03-11 14:00", "2015-03-11 16:00", 2)
    add_private_event("ADS2 (Lecture)", 1, "2015-03-12 11:00", "2015-03-12 12:00", 2)
    add_private_event("Web App Development (Lecture)", 1, "2015-03-13 11:00", "2015-03-13 12:00", 2)
    add_private_event("ADS2 (Examples)", 1, "2015-03-13 13:00", "2015-03-13 14:00", 2)
    add_private_event("JOOSE 2 (Tutorial)", 1, "2015-03-13 14:00", "2015-03-13 15:00", 2)
    add_private_event("Hearts vs Celtic", 2, "2015-03-15 19:00", "2015-03-15 21:00", 2)
    add_private_event("Red Hot Chilli Peppers gig", 2, "2015-03-07 19:00", "2015-03-07 22:00", 2)
    ############### Week 3 (March)
    add_private_event("JOOSE 2 (Lecture)", 1, "2015-03-16 11:00", "2015-03-16 12:00", 2)
    add_private_event("ADS2 (Lecture)", 1, "2015-03-17 11:00", "2015-03-17 12:00", 2)
    add_private_event("Web App Development (Lecture)", 1, "2015-03-18 11:00", "2015-03-18 12:00", 2)
    add_private_event("JOOSE 2 (Lecture)", 1, "2015-03-18 13:00", "2015-03-18 14:00", 2)
    add_private_event("Web App Development (Lab)", 1, "2015-03-18 14:00", "2015-03-18 16:00", 2)
    add_private_event("ADS2 (Lecture)", 1, "2015-03-19 11:00", "2015-03-19 12:00", 2)
    add_private_event("Web App Development (Lecture)", 1, "2015-03-20 11:00", "2015-03-20 12:00", 2)
    add_private_event("ADS2 (Examples)", 1, "2015-03-20 13:00", "2015-03-20 14:00", 2)
    add_private_event("JOOSE 2 (Tutorial)", 1, "2015-03-20 14:00", "2015-03-20 15:00", 2)
    add_private_event("Hearts vs Rangers", 2, "2015-03-22 19:00", "2015-03-22 21:00", 2)
	
    # Add events to Susie's calendars
    add_private_event("Client meeting", 1, "2015-03-02 13:10", "2015-03-02 13:40", 3)
    add_private_event("Shipping meeting", 1, "2015-03-02 14:00", "2015-03-02 15:00", 3)
    add_private_event("HR Meeting", 1, "2015-03-03 10:00", "2015-03-03 11:30", 3)
    add_private_event("Jack's football practice", 2, "2015-03-05 16:00", "2015-03-05 18:00", 3)
    add_private_event("Jack's track day", 2, "2015-03-06 13:30", "2015-03-06 17:00", 3)
    add_private_event("Rachael's piano practice", 3, "2015-03-16 15:00", "2015-03-16 17:00", 3)
